...
var MentionFormField = function (_FormField) {
    ...
    function MentionFormField(props) {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(MentionFormField).call(this, props));
    }

    _createClass(MentionFormField, [{
        key: 'handleChange',
        ...
        key: 'getPersonData',
        value: function getPersonData(keyword, next) {
            setTimeout(function () {
                next(mockData);
            }, 100);
        }
    }, {
        key: 'personDataFormatter',
        value: function personDataFormatter(data) {
        ...
        key: 'personPanelFormatter',
        value: function personPanelFormatter(data) {
            return '<img src="' + data.avatar + '" width="25" height="25" title="' + data.name + '">' + data.displayName + ' - ' + data.emplId;
        }
    }, {
        key: 'personMentionFormatter',
        value: function personMentionFormatter(data) {
